...
class LoginSerializer(serializers.Serializer):
    ...
    def _validate_username(self, phone_number, password):
    ...
    def get_auth_user_using_allauth(self, phone_number, password):
        from allauth.account import app_settings


        # Authentication through username
        if app_settings.AUTHENTICATION_METHOD == app_settings.AuthenticationMethod.USERNAME:
            return self._validate_username(phone_number, password)

        # Authentication through either username or email
        return self._validate_username_email(phone_number, password)

    def get_auth_user_using_orm(self, phone_number, password):
    ...
    def get_auth_user(self, phone_number, password):
        ...
        if 'allauth' in settings.INSTALLED_APPS:
            ...
            try:
                return self.get_auth_user_using_allauth(phone_number, password)
            except url_exceptions.NoReverseMatch:
                msg = _('Unable to log in with provided credentials.')
                raise exceptions.ValidationError(msg)
        return self.get_auth_user_using_orm(phone_number, password)
